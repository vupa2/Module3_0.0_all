...
<body>
    <nav class="navbar navbar-light bg-light">
        <div class="container-fluid w-75">
            ...
            <div>
                <a class="btn btn-primary" type="submit" href="{{ route('products.baskets.index') }}">Giỏ hàng</a>
                <a class="btn btn-danger" type="submit" href="{{ route('products.index') }}">Trang Chủ</a>
            </div>
        </div>
    </nav>
