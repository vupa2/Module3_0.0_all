...
class TaskController extends Controller
{
    ...
    public function store(TaskFormRequest $request)
    {
        ...
        return redirect()->route('tasks.index')->with('success', trans('create success'));
    }
    ...
    public function update(TaskFormRequest $request, Task $task)
    {
        ...
        return redirect()->route('tasks.index')->with('success', trans('updated success'));
    }
    ...
    public function destroy(Task $task)
    {
        ...
        return redirect()->route('tasks.index')->with('success', trans('delete success'));
    }
}
